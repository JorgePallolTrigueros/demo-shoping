...
public interface ShoppingCartApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "search results matching criteria", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = InvoiceShoppingCart.class))
            })
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<InvoiceShoppingCart> buyShoppingCart(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"totalTax\" : 10, \"datetime\" : \"2024-03-16T15:28:42.183Z\", \"total\" : 10, \"subtotal\" : 10, \"businessId\" : \"B123456\", \"businessName\" : \"tienda s.l.\", \"taxDescription\" : \"IVA\", \"tax\" : 0.21, \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"email\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"products\" : [ { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" }, { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" } ] }";
    ...
    default ResponseEntity<List<ShoppingCartItem>> getAllShoppingCarts(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"subtotal\" : 10, \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"products\" : [ { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" }, { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" } ] }, { \"subtotal\" : 10, \"id\" : \"d290f1ee-6c54-4b01-90e6-d701748f0851\", \"products\" : [ { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" }, { \"quantity\" : 1, \"originalPrice\" : 10, \"price\" : 10, \"subtotal\" : 10, \"name\" : \"producto 1\", \"description\" : \"description 1\", \"id\" : 1, \"galleries\" : [ \"galleries\", \"galleries\" ], \"category\" : \"category 1\" } ] } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
